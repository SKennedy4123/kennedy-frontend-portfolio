...
export default function Projects () {
  ...
  <div class="col-sm-4">
    <div class="card">
      <div class="card-body">
        <img src={DictionaryApp} class="card-img-top img-fluid img-thumbnail" alt="..." />
  ...
  <div class="col-sm-4">
    <div class="card">
      <div class="card-body">
        <img src={WeatherApp} class="card-img-top img-fluid img-thumbnail" alt="..." />
    ...
    <div class="card">
      <div class="card-body">
        <img src={Travel} class="card-img-top img-fluid img-thumbnail" alt="..." />
